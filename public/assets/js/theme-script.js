...
<div class="sidebar-contact ">
    ...
    <div class="offcanvas-header d-flex align-items-center justify-content-between bg-primary">
        ...
        <Link href="#" class="close d-flex align-items-center justify-content-center"  data-bs-dismiss="offcanvas"><i class="isax isax-close-circle"></i></a>
    </div>
    <div class="themesettings-inner offcanvas-body">
                    ...
                    <div class="accordion-body">
                     <div class="theme-content">
                        <div class="row gx-3">
                            ...
                            <div class="col-4">
                                <Link href="layout-rtl.html" class="theme-layout mb-3 text-center">
                                    <span class="d-block mb-2 layout-img">
        ...
        <div class="p-3 border-top">
            <div class="row gx-3">
                <div class="col-6">
                    <Link href="#" id="resetbutton" class="btn btn-light close-theme w-100"><i class="ti ti-restore me-1"></i>Reset</a>
                </div>
                <div class="col-6">
                    <Link href="#" class="btn btn-primary w-100" data-bs-dismiss="offcanvas"><i class="ti ti-shopping-cart-plus me-1"></i>Buy Product</a>
                </div>
            </div>
        </div>    
    </div> `
