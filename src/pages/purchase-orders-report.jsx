  ...
  return (
    <>
      <div className="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
        <div>
          <h6 className="mb-0">Purchase Orders Report</h6>
        </div>
          ...
          <div className="card position-relative">
            <div className="card-body">
              <div className="d-flex align-items-center justify-content-between">
                <div>
                  <p className="mb-1 text-truncate">Total Purchase Orders</p>
                  <h6 className="fs-16 fw-semibold mb-0">280</h6>
                </div>
                <div>
        ...
        <div className="col-xl-3 col-lg-4 col-md-6">
          <div className="card position-relative">
            <div className="card-body">
              <div className="d-flex align-items-center justify-content-between">
                <div>
                  <p className="mb-1 text-truncate"> Completed Orders</p>
                  <h6 className="fs-16 fw-semibold mb-0">240</h6>
                </div>
                <div>
        ...
        <div className="col-xl-3 col-lg-4 col-md-6">
          <div className="card position-relative">
            <div className="card-body">
              <div className="d-flex align-items-center justify-content-between">
                <div>
                  <p className="mb-1 text-truncate"> Pending Orders</p>
                  <h6 className="fs-16 fw-semibold mb-0">30</h6>
                </div>
                <div>
        ...
        <div className="col-xl-3 col-lg-4 col-md-6">
          <div className="card position-relative">
            <div className="card-body">
              <div className="d-flex align-items-center justify-content-between">
                <div>
                  <p className="mb-1 text-truncate">Cancelled Orders</p>
                  <h6 className="fs-16 fw-semibold mb-0">10</h6>
                </div>
                <div>
        ...
        <table className="table table-nowrap datatable">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <Link href="#" className="badge-primary">
                  PUR00019
                </Link>
              </td>
              <td>15 Nov 2024</td>
              ...
              <div className="dropdown">
                ...
                <div className="dropdown-menu shadow-lg w-100 dropdown-info">
                  <ul className="mb-3">
                    <li>
                      <label className="dropdown-item px-2 d-flex align-items-center text-dark">
                        <input className="form-check-input m-0 me-2" type="checkbox" checked /> Cash
                      </label>
                    </li>
                    <li>
                      <label className="dropdown-item px-2 d-flex align-items-center text-dark">
                    ...
                    <li>
                      <label className="dropdown-item px-2 d-flex align-items-center text-dark">
                        <input className="form-check-input m-0 me-2" type="checkbox" checked /> Bank
                        Transfer
                      </label>
                    </li>
                    <li>
