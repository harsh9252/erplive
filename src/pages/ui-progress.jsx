      ...
      <div className="row">
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              <p>
                Use the <code>.progress</code> as a wrapper to indicate the max value of the
                progress bar.
              </p>
              <div
        ...
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              <p className="text-muted">
                We only set a <code>height</code> value on the <code>.progress</code>, so if you
                change that value the inner <code>.progress-bar</code> will automatically resize
                accordingly. Use <code>.progress-sm</code>,<code>.progress-md</code>,
                <code>.progress-lg</code>,<code>.progress-xl</code> classes.
              </p>
              <div className="progress mb-3" style={{ height: '1px;' }}>
                <div
        ...
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              <p>
                The striped gradient can also be animated. Add <code>.progress-bar-animated</code>{' '}
        ...
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              <p>
                Add <code>.bg-primary-gradient</code> to any <code>.progress-bar</code> to apply a
