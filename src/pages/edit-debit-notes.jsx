      ...
      <div className="row">
        <div className="col-md-11 mx-auto">
          <div className="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
            <div>
              <h6>
                <Link to="/debit-notes" className="d-flex align-items-center ">
                  <i className="isax isax-arrow-left me-2"></i>Debit Note
                </Link>
              </h6>
            </div>
