            ...
            <div className="card-body">
              <div className="bg-light rounded p-3 mb-3">
                <div className="text-center mb-3">
                  <Link href="#" className="avatar avatar-xl online avatar-rounded">
              ...
              <div className="mb-3">
                ...
                >
                  <i className="ti ti-circle-plus me-2"></i>Create Post
                </Link>
              </div>
              <div className="files-list border-bottom pb-2 mb-3">
                ...
                >
                  <span>
                    <i className="ti ti-brand-feedly me-2"></i>All Feeds
                  </span>
                  <span className="badge bg-danger badge-xs rounded-pill">56</span>
                </Link>
                <Link href="javscript:void(0);" className="d-flex align-items-center fw-medium p-2">
                  <i className="ti ti-mood-search me-2"></i>Explore
                </Link>
                <Link href="javscript:void(0);" className="d-flex align-items-center fw-medium p-2">
                  <i className="ti ti-mail-check me-2"></i>Messages
                </Link>
                <Link href="javscript:void(0);" className="d-flex align-items-center fw-medium p-2">
                  <i className="ti ti-list me-2"></i>Lists
                </Link>
                <Link href="javscript:void(0);" className="d-flex align-items-center fw-medium p-2">
                  <i className="ti ti-bookmark me-2"></i>Bookmark
                </Link>
                <Link href="javscript:void(0);" className="d-flex align-items-center fw-medium p-2">
                  <i className="ti ti-coffee me-2"></i>Marketplace
                </Link>
                <Link
                  href="javscript:void(0);"
                ...
                >
                  <span>
                    <i className="ti ti-file-text me-2"></i>Files
                  </span>
                  <span className="badge bg-info badge-xs rounded-pill">14</span>
                </Link>
                <Link href="javscript:void(0);" className="d-flex align-items-center fw-medium p-2">
                  <i className="ti ti-music me-2"></i>Media
                </Link>
                <Link href="javscript:void(0);" className="d-flex align-items-center fw-medium p-2">
                  <i className="ti ti-user-share me-2"></i>Profile
                </Link>
              </div>
              <div>
                <div className="mb-2">
                ...
                <div>
                  ...
                  >
                    <span className="d-inline-flex align-items-center">
                      <img src="/assets/img/icons/liked-page-01.svg" className="me-2" alt="Img" />
                      Dribble
                    </span>
                  ...
                  >
                    <span className="d-inline-flex align-items-center">
                      <img src="/assets/img/icons/liked-page-02.svg" className="me-2" alt="Img" />
                      UI/UX Designs
                    </span>
                    <span className="btn btn-icon btn-sm">
                      <i className="ti ti-thumb-down"></i>
                  ...
                  >
                    <span className="d-inline-flex align-items-center">
                      <img src="/assets/img/icons/liked-page-03.svg" className="me-2" alt="Img" />
                      Figma Update
                    </span>
                    <span className="btn btn-icon btn-sm">
                      <i className="ti ti-thumb-down"></i>
                ...
                <form onSubmit={(e) => { e.preventDefault(); }}>
                  ...
                  <div className="d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                    <div className="d-flex align-items-center">
                      ...
                      <Link href="#" className="btn btn-icon btn-sm rounded-circle">
                        <i className="ti ti-paperclip fs-16"></i>
                      </Link>
                      <Link href="#" className="btn btn-icon btn-sm rounded-circle">
                        <i className="ti ti-video fs-16"></i>
                      </Link>
                      <Link href="#" className="btn btn-icon btn-sm rounded-circle">
                        <i className="ti ti-hash fs-16"></i>
                      </Link>
                      <Link href="#" className="btn btn-icon btn-sm rounded-circle">
                        <i className="ti ti-map-pin-heart fs-16"></i>
                      </Link>
                      <Link href="#" className="btn btn-icon btn-sm rounded-circle">
                        <i className="ti ti-mood-smile fs-16"></i>
                      </Link>
                    </div>
                    <div className="d-flex align-items-center">
                      <Link href="#" className="btn btn-icon btn-sm rounded-circle">
                        <i className="ti ti-refresh fs-16"></i>
                      </Link>
                      <Link href="#" className="btn btn-icon btn-sm rounded-circle">
                        <i className="ti ti-trash fs-16"></i>
                      </Link>
                      <Link href="#" className="btn btn-icon btn-sm rounded-circle">
                        <i className="ti ti-world fs-16"></i>
                      </Link>
                      <button
                        type="submit"
                        className="btn btn-primary d-inline-flex align-items-center ms-2"
                      >
                        <i className="ti ti-circle-plus fs-16 me-2"></i>Share Post
                      </button>
                    </div>
                  </div>
                </form>
            ...
            <div className="card">
              <div className="card-body">
                <div className="d-flex align-items-center mb-3">
                  <h6 className="me-2">Popular Channels</h6>
            ...
            <div className="card">
              <div className="card-header border-0 pb-0">
                <div className="d-flex align-items-center justify-content-between border-bottom flex-wrap row-gap-3 pb-3">
                  <div className="d-flex align-items-center">
                    <Link href="#" className="avatar avatar-lg avatar-rounded flex-shrink-0 me-2">
                      <img src="/assets/img/users/user-03.jpg" alt="Img" />
                    </Link>
                    <div>
                      <h6 className="mb-1">
                        <Link href="#">
                          Richard Smith <i className="ti ti-circle-check-filled text-success"></i>
                        </Link>
                      </h6>
                      <p className="d-flex align-items-center">
                        <span className="text-info">@richard442</span>
                        <i className="ti ti-circle-filled fs-5 mx-2"></i> United Kingdom
                      </p>
                    </div>
                  </div>
                  <div className="d-flex align-items-center">
                    ...
                    <div className="dropdown">
                      ...
                      <ul className="dropdown-menu dropdown-menu-end p-3">
                        ...
                        <li>
                          <Link href="#" className="dropdown-item rounded-1">
                            <i className="ti ti-eye me-2"></i>Hide Post
                          </Link>
                        </li>
                        <li>
                          <Link href="#" className="dropdown-item rounded-1">
                            <i className="ti ti-report me-2"></i>Report
                          </Link>
                        </li>
                        <li>
                          <Link href="#" className="dropdown-item rounded-1">
              ...
              <div className="card-body">
                ...
                <div className="social-gallery-slider owl-carousel mb-3">
                  <Link
                    href="assets/img/social/gallery-big-01.jpg"
                  ...
                  <Link
                    href="assets/img/social/gallery-big-02.jpg"
                    data-fancybox="gallery"
                    className="gallery-item"
                  >
                  ...
                  <Link
                    href="assets/img/social/gallery-big-03.jpg"
                    data-fancybox="gallery"
                    className="gallery-item"
                  >
                  ...
                  <Link
                    href="assets/img/social/gallery-big-04.jpg"
                    data-fancybox="gallery"
                    className="gallery-item"
                  >
                ...
                <div className="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                  <div className="d-flex align-items-center flex-wrap row-gap-3">
                    <Link href="#" className="d-inline-flex align-items-center me-3">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <Link href="#" className="btn btn-icon btn-sm rounded-circle">
                      <i className="ti ti-bookmark-filled text-warning"></i>
                    </Link>
                  </div>
                </div>
                <div className="d-flex align-items-start">
                  <Link href="#" className="avatar avatar-rounded me-2 flex-shrink-0">
                ...
                <div className="d-flex align-items-center justify-content-between border-bottom flex-wrap row-gap-3 pb-3">
                  <div className="d-flex align-items-center">
                    ...
                    <div>
                      <h6 className="mb-1">
                        <Link href="#">
                          Jason Heier <i className="ti ti-circle-check-filled text-success"></i>
                        </Link>
                      </h6>
                      <p className="d-flex align-items-center">
                ...
                <div className="card shadow-none mb-3">
                  ...
                  <div className="card-body p-2">
                    <h6 className="mb-1 text-truncate">
                      <Link href="#">Drinking water boosts skin health and beauty. Stay hydrated!💧</Link>
                    </h6>
            ...
            <div className="card">
                ...
                <div className="d-flex align-items-center justify-content-between border-bottom flex-wrap row-gap-3 pb-3">
                  <div className="d-flex align-items-center">
                    ...
                    <div>
                      <h6 className="mb-1">
                        <Link href="#">
                          Sophie Headrick <i className="ti ti-circle-check-filled text-success"></i>
                        </Link>
                      </h6>
                      <p className="d-flex align-items-center">
              ...
              <div className="card-body">
                ...
                <div className="d-flex align-items-start mb-3">
                  <Link href="#" className="avatar avatar-rounded flex-shrink-0 me-2">
                  ...
                  <div className="bg-light rounded flex-fill p-2">
                    ...
                    <Link href="#" className="d-inline-flex align-items-center">
                      <i className="ti ti-share-3 me-2"></i>Reply
                    </Link>
                  </div>
                </div>
                <div className="d-flex align-items-start mb-3 ms-4 ps-2">
                  ...
                  <div className="bg-light rounded flex-fill p-2">
                    ...
                    <p className="mb-1">Thank you so much for your enthusiasm and support!</p>
                    <Link href="#" className="d-inline-flex align-items-center">
                      <i className="ti ti-share-3 me-2"></i>Reply
                    </Link>
                  </div>
                ...
                <div>
                  ...
                  <div className="view-all text-center mb-3">
                    <Link href="#" className="viewall-button text-primary fw-medium">
            ...
            <div className="card-body">
              ...
              <div className="bg-light rounded p-2 mb-2">
                <div className="d-flex align-items-center justify-content-between mb-1">
                  <Link href="#" className="d-flex align-items-center">
                    <span>
                      <img src="/assets/img/icons/feeds-01.svg" className="me-2" alt="Img" />
                    </span>
                ...
                <p className="text-dark fw-medium">
                  <Link href="#">Retail investor party continues even as</Link>
                </p>
              </div>
              <div className="bg-light rounded p-2 mb-2">
                <div className="d-flex align-items-center justify-content-between mb-1">
                  <Link href="#" className="d-flex align-items-center">
                    <span>
                      <img src="/assets/img/icons/feeds-02.svg" className="me-2" alt="Img" />
                    </span>
              ...
              <div className="bg-light rounded p-2 mb-2">
                <div className="d-flex align-items-center justify-content-between mb-1">
                  <Link href="#" className="d-flex align-items-center">
                    <span>
                      <img src="/assets/img/icons/feeds-03.svg" className="me-2" alt="Img" />
                    </span>
              ...
              <div className="bg-light rounded p-2">
                <div className="d-flex align-items-center justify-content-between mb-1">
                  <Link href="#" className="d-flex align-items-center">
                    <span>
                      <img src="/assets/img/icons/feeds-04.svg" className="me-2" alt="Img" />
                    </span>
            ...
            <div className="card-body">
              <div className="card-img card-img-hover mb-3">
                <Link href="#" className="rounded">
                  <img src="/assets/img/social/social-feed-04.jpg" className="rounded" alt="Img" />
                </Link>
              </div>
              <h6 className="text-center fs-14">
                <Link href="#">Enjoy Unlimited Access on a small price monthly.</Link>
              </h6>
              <div className="mt-3">
                <Link href="#" className="btn btn-white w-100 border">
                  Upgrade Now <i className="ti ti-arrow-right ms-2"></i>
                </Link>
              </div>
            </div>
          </div>
          <div className="d-flex align-items-center flex-wrap justify-content-center template-more-links gap-3">
