    ...
    <>
      ...
      <div className="row">
        ...
        <div className="col-lg-6">
          <div className="card">
            <div className="card-header">
              <h5 className="card-title">Border Table</h5>
            </div>
            <div className="card-body">
              <div className="table-responsive">
      ...
      <div className="row">
                ...
                <table className="table table-nowrap mb-0">
                  ...
                  <tbody>
                    <tr>
                      <td>Default</td>
                      <td>Defaultson</td>
                      <td>default@example.com</td>
                    </tr>
                    <tr className="table-primary">
                      <td>Primary</td>
                      <td>Doe</td>
                      <td>primary@example.com</td>
                    </tr>
                    <tr className="table-secondary">
                      <td>Secondary</td>
                      <td>Moe</td>
                      <td>secondary@example.com</td>
                    </tr>
                    <tr className="table-success">
                      <td>Success</td>
                      <td>Dooley</td>
                      <td>success@example.com</td>
                    </tr>
                    <tr className="table-danger">
                      <td>Danger</td>
                      <td>Refs</td>
                      <td>danger@example.com</td>
                    </tr>
                    <tr className="table-warning">
                      <td>Warning</td>
                      <td>Activeson</td>
                      <td>warning@example.com</td>
                    </tr>
        ...
        <div className="col-lg-6">
          <div className="card">
            ...
            <div className="card-body">
              <div className="table-responsive">
                <table className="table table-nowrap table-nowrap mb-0">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>Firstname</th>
      ...
      <div className="row">
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              <div className="table-responsive">
                <table className="table table-nowrap text-nowrap table-borderless">
                  <thead>
                    <tr>
        ...
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              <div className="table-responsive">
                <table className="table table-nowrap text-nowrap table-striped">
                  <thead>
                    <tr>
                      <th scope="col">ID</th>
                    ...
                    <tr>
                      ...
                      <td>
                        <button className="btn btn-sm btn-success btn-wave waves-effect waves-light">
                          <i className="feather-download align-middle me-2 d-inline-block"></i>
                          Download
                        </button>
                      </td>
                    </tr>
      ...
      <div className="row">
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              <div className="table-responsive">
                <table className="table table-nowrap text-nowrap table-striped-columns">
                  <thead>
                    <tr>
                      <th scope="col">ID</th>
                      <th scope="col">Date</th>
                    ...
                    <tr>
                      ...
                      <td>
                        <button className="btn btn-sm btn-danger btn-wave waves-effect waves-light">
                          <i className="feather-trash align-middle me-2 d-inline-block"></i>Delete
                        </button>
                      </td>
                    </tr>
                    <tr>
        ...
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              <div className="table-responsive">
                <table className="table table-nowrap text-nowrap table-sm">
                  <thead>
                    <tr>
      ...
      <div className="row">
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              <div className="table-responsive">
                <table className="table table-nowrap text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div className="hstack gap-2 fs-15">
                          <Link href="#" className="btn btn-icon btn-sm btn-soft-success rounded-pill">
                            <i className="feather-download"></i>
                          </Link>
                          <Link href="#" className="btn btn-icon btn-sm btn-soft-info rounded-pill">
                            <i className="feather-edit"></i>
                          </Link>
                          <Link href="#" className="btn btn-icon btn-sm btn-soft-danger rounded-pill">
        ...
        <div className="col-xl-12">
          <div className="card">
            ...
            <div className="card-body">
              <div className="table-responsive">
                <table className="table table-nowrap text-nowrap table-hover">
                  <thead>
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <div className="lh-1">
                              <span className="fs-11 text-muted">joanna@example.com</span>
                            </div>
                          </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <div className="lh-1">
                              <span className="fs-11 text-muted">kara@example.com</span>
                            </div>
                          </div>
                        </div>
                      </td>
                      <td>
                        <span className="badge bg-warning">Clothing</span>
                      </td>
                      <td>
                        <div className="avatar-list-stacked">
                          <span className="avatar avatar-sm avatar-rounded">
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <div className="lh-1">
                              <span className="fs-11 text-muted">donald@example.com</span>
                            </div>
                          </div>
                        </div>
                      </td>
                      <td>
                        <span className="badge bg-dark">Electronics</span>
                      </td>
                      <td>
                        <div className="avatar-list-stacked">
                          <span className="avatar avatar-sm avatar-rounded">
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <div className="lh-1">
                              <span className="fs-11 text-muted">justin@example.com</span>
                            </div>
                          </div>
                        </div>
                      </td>
                      <td>
                        <span className="badge bg-danger">Sports</span>
                      </td>
                      <td>
                        <div className="avatar-list-stacked">
                          <span className="avatar avatar-sm avatar-rounded">
        ...
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              <div className="table-responsive">
                <table className="table table-nowrap text-nowrap table-striped table-hover">
                  <thead>
                    <tr>
                      <th scope="col">Invoice</th>
                      <th scope="col">Customer</th>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <div className="lh-1">
                              <span className="fs-11 text-muted">mark@example.com</span>
                            </div>
                          </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <div className="lh-1">
                              <span className="fs-11 text-muted">charanjeep@example.com</span>
                            </div>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <div className="lh-1">
                              <span className="fs-11 text-muted">samantha@example.com</span>
                            </div>
                          </div>
                        </div>
                      </td>
                      <td>
                        <span className="badge bg-danger">
                          <i className="ri-close-fill align-middle me-1"></i>Cancelled
                        </span>
                      </td>
                      <td>Feb 1,2022</td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <span className="badge bg-light text-dark">
                          <i className="ri-reply-line align-middle me-1"></i>Refunded
                        </span>
                      </td>
                      <td>Apr 24,2022</td>
                    </tr>
                ...
                <table className="table table-nowrap text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <span className="badge bg-success">Manager</span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>Recruiter</td>
                      <td>
                        <span className="badge bg-danger">Employee</span>
                      </td>
                      <td>mirinda@example.com</td>
                      <td>
                        <div className="avatar-list-stacked">
                          <span className="avatar avatar-sm avatar-rounded">
                            <img src="/assets/img/profiles/avatar-03.jpg" alt="img" />
      ...
      <div className="row">
        <div className="col-xl-12">
          <div className="card">
            ...
            <div className="card-body">
              <div className="table-responsive">
                <table className="table table-nowrap text-nowrap table-primary mb-0">
                  <thead>
                    <tr>
                      <th scope="col">#</th>
              ...
              <div className="table-responsive">
                <table className="table">
                  <thead className="table-primary">
                    <tr>
                      <th>#</th>
                      <th className="w-25">table-primary</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
              ...
              <div className="table-responsive">
                <table className="table">
                  <thead className="table-secondary">
                    <tr>
                      <th>#</th>
                      <th className="w-25">table-secondary</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
              ...
              <div className="table-responsive">
                <table className="table">
                  <thead className="table-success">
                    <tr>
                      <th>#</th>
                      <th className="w-25">table-success</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
              ...
              <div className="table-responsive">
                <table className="table">
                  <thead className="table-warning">
                    <tr>
                      <th>#</th>
                      <th className="w-25">table-warning</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
              ...
              <div className="table-responsive">
                <table className="table">
                  <thead className="table-info">
                    <tr>
                      <th>#</th>
                      <th className="w-25">table-info</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
              ...
              <div className="table-responsive">
                <table className="table">
                  <thead className="table-danger">
                    <tr>
                      <th>#</th>
                      <th className="w-25">table-danger</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
              ...
              <div className="table-responsive">
                <table className="table table-nowrap">
                  <thead className="table-dark">
                    <tr>
                      <th>#</th>
                      <th className="w-25">table-dark</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
              ...
              <div className="table-responsive">
                <table className="table table-nowrap mb-0">
                  <thead className="table-light">
                    <tr>
                      <th>#</th>
                      <th className="w-25">table-light</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
        ...
        <div className="col-xl-12">
          <div className="card">
            ...
            <div className="card-body">
              <div className="table-responsive">
                <table className="table">
                  <thead className="bg-primary-gradient">
                    <tr>
                      <th>#</th>
                      <th className="w-25">.bg-primary.bg-gradient</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
              ...
              <div className="table-responsive">
                <table className="table">
                  <thead className="bg-dark-gradient">
                    <tr>
                      <th className="text-white">#</th>
                      <th className="w-25 text-white">.bg-secondary.bg-gradient</th>
              ...
              <div className="table-responsive">
                <table className="table">
                  <thead className="bg-success-gradient">
                    <tr>
                      <th>#</th>
                      <th className="w-25">.bg-success.bg-gradient</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
              ...
              <div className="table-responsive">
                <table className="table">
                  <thead className="bg-warning-gradient">
                    <tr>
                      <th>#</th>
                      <th className="w-25">.bg-warning.bg-gradient</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
              ...
              <div className="table-responsive">
                <table className="table">
                  <thead className="bg-info-gradient">
                    <tr>
                      <th>#</th>
                      <th className="w-25">.bg-info.bg-gradient</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
              ...
              <div className="table-responsive">
                <table className="table">
                  <thead className="bg-danger-gradient">
                    <tr>
                      <th>#</th>
                      <th className="w-25">.bg-danger.bg-gradient</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
              ...
              <div className="table-responsive">
                <table className="table table-nowrap">
                  <thead className="bg-dark-gradient text-white">
                    <tr>
                      <th className="text-white">#</th>
                      <th className="w-25 text-white">.bg-dark.bg-gradient</th>
                      <th className="text-white">Last Name</th>
                      <th className="text-white">Username</th>
                      <th className="text-white">Role</th>
                    </tr>
              ...
              <div className="table-responsive">
                <table className="table table-nowrap mb-0">
                  <thead className="bg-light-gradient">
                    <tr>
                      <th>#</th>
                      <th className="w-25">.bg-light.bg-gradient</th>
                      <th>Last Name</th>
                      <th>Username</th>
                      <th>Role</th>
                    </tr>
