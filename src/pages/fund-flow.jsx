...
const initialData = [
  { id: 1, date: '22 Feb 2025', bankNo: 'GTB - 3298784309485', description: 'Sale of laptops', credit: '15,000', debit: '5,000', accountBalance: '10,000', totalBalance: '10,000', paymentMode: 'Fund' },
  ...
  { id: 3, date: '30 Jan 2025', bankNo: 'SFB - 3255465758698', description: 'Office Supplies Bought', credit: '30,000', debit: '10,000', accountBalance: '20,000', totalBalance: '50,125', paymentMode: 'Fund' },
  ...
  { id: 5, date: '04 Jan 2025', bankNo: 'ETB - 4324356677889', description: 'Electricity Bill Paid', credit: '18,000', debit: '6,000', accountBalance: '12,000', totalBalance: '99,999', paymentMode: 'Fund' },
  ...
  { id: 7, date: '02 Dec 2024', bankNo: 'SDB - 3354456565687', description: 'Customer Refund', credit: '35,000', debit: '12,000', accountBalance: '23,000', totalBalance: '2,50,000', paymentMode: 'Fund' },
  ...
  { id: 9, date: '30 Nov 2024', bankNo: 'CCB - 9876543210123', description: 'Freelance Payment', credit: '27,500', debit: '15,000', accountBalance: '18,000', totalBalance: '7,50,300', paymentMode: 'Fund' },
  ...
  { id: 11, date: '05 Oct 2024', bankNo: 'ICB - 6543217896543', description: 'Subscription Sale', credit: '45,000', debit: '7,000', accountBalance: '27,000', totalBalance: '87,650', paymentMode: 'Fund' },
  ...
  { id: 13, date: '02 Sep 2024', bankNo: 'RFB - 3214569873214', description: 'Inventory Restock', credit: '38,000', debit: '14,000', accountBalance: '24,000', totalBalance: '33,210', paymentMode: 'Fund' },
];
  ...
  return (
    <>
      <div className="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
        <div>
          <h6 className="mb-0">Fund Flow Report</h6>
        </div>
              ...
              <div className="card-body">
                <div className="d-flex align-items-center justify-content-between">
                  <div className="mb-0 me-2">
                    ...
                    <p className="mb-1 text-truncate">Opening Fund Balance</p>
              ...
              <div className="card-body">
                <div className="d-flex align-items-center justify-content-between">
                  <div className="mb-0 me-2">
                    ...
                    <p className="mb-1 text-truncate">Closing Fund Balance</p>
                    <p className="fs-13 mb-0 text-truncate">
                      <span className="text-success">
              ...
              <div className="card-body">
                <div className="d-flex align-items-center justify-content-between">
                  <div className="mb-0 me-2">
                    ...
                    <p className="mb-1 text-truncate"> Net Fund Flow</p>
                    <p className="fs-13 mb-0 text-truncate">
                      <span className="text-success">
              ...
              <div className="card-body">
                <div className="d-flex align-items-center justify-content-between">
                  <div className="mb-0 me-2">
                    ...
                    <p className="mb-1 text-truncate">Fund Inflows</p>
                    <p className="fs-13 mb-0 text-truncate">
                      <span className="text-success">
                  ...
                  <ul className="mb-3">
                    ...
                    <li>
                      <label className="dropdown-item px-2 d-flex align-items-center text-dark">
                        <input className="form-check-input m-0 me-2" type="checkbox" /> Fund
                      </label>
                    </li>
                    <li>
                      <label className="dropdown-item px-2 d-flex align-items-center text-dark">
