      ...
      <div className="row">
          ...
          <div className="card">
            ...
            <div className="card-body">
              <p className="text-muted">
                ...
                the link styles use a relatively light foreground color, and should only be used on
        ...
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              <p className="text-muted">
                <Link to="/ui-utilities">Colored link helpers</Link> have been updated to pair with our
                link utilities. Use the new utilities to modify the link opacity, underline opacity,
      ...
      <div className="row">
        ...
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              <p className="text-muted">
                Change the underline’s opacity. Requires adding <code>.link-underline</code> to
                first set an <code>rgba()</code> color we use to then modify the alpha opacity.
              </p>
              <p>
                <Link 
