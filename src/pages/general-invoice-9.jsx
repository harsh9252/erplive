          ...
          <div className="mb-3 border-bottom">
            <div className="d-flex align-items-center justify-content-between flex-wrap p-3 rounded">
              <div className="">
                ...
                <div>
                  <h6 className="mb-1">Dreamstechnologies Internet Pvt Ltd.,</h6>
                  <div>
                    <p className="mb-1">
                      Address :{' '}
          ...
          <div className="row border-top border-bottom p-2">
            ...
            <div className="col-md-4">
              <div className="d-flex align-items-center justify-content-between">
                <div className=" text-end">
                  <span className="fw-bold fs-18 text-end text-primary">Total</span>
                </div>
                <div className="text-end">
                  <span className="fw-bold fs-18 text-primary">$1,815.00</span>
                </div>
              </div>
            </div>
          </div>
          <div className="row py-3 border-bottom mb-3 d-flex align-items-center">
...
export default GeneralInvoice9;
