...
const AddVendor = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const vendorData = {
        ...formData,
        state_code: formData.state, // Map 'state' to 'state_code' as expected by API
        opening_balance: 0, // Default for new vendors if not provided
      ...
      const errorMessage = err.message || 'Failed to add vendor. Please try again.';
