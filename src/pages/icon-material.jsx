            ...
            <div className="card-body">
              <div className="icons-items">
                <ul className="icons-list">
                  ...
                  <li>
                    <i className="mdi mdi-account" data-bs-toggle="tooltip" title="mdi-account"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-adjust" data-bs-toggle="tooltip" title="mdi-adjust"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-airplay" data-bs-toggle="tooltip" title="mdi-airplay"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-alarm" data-bs-toggle="tooltip" title="mdi-alarm"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-album" data-bs-toggle="tooltip" title="mdi-album"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-alert" data-bs-toggle="tooltip" title="mdi-alert"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-alpha" data-bs-toggle="tooltip" title="mdi-alpha"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-amazon" data-bs-toggle="tooltip" title="mdi-amazon"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-anchor" data-bs-toggle="tooltip" title="mdi-anchor"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-android" data-bs-toggle="tooltip" title="mdi-android"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-angular" data-bs-toggle="tooltip" title="mdi-angular"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-apple" data-bs-toggle="tooltip" title="mdi-apple"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-apps" data-bs-toggle="tooltip" title="mdi-apps"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-archive" data-bs-toggle="tooltip" title="mdi-archive"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-at" data-bs-toggle="tooltip" title="mdi-at"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-atom" data-bs-toggle="tooltip" title="mdi-atom"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-baby" data-bs-toggle="tooltip" title="mdi-baby"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-bank" data-bs-toggle="tooltip" title="mdi-bank"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-barcode" data-bs-toggle="tooltip" title="mdi-barcode"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-barley" data-bs-toggle="tooltip" title="mdi-barley"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-barrel" data-bs-toggle="tooltip" title="mdi-barrel"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-basket" data-bs-toggle="tooltip" title="mdi-basket"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-battery" data-bs-toggle="tooltip" title="mdi-battery"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-beach" data-bs-toggle="tooltip" title="mdi-beach"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-zip-box" data-bs-toggle="tooltip" title="mdi-zip-box"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-yelp" data-bs-toggle="tooltip" title="mdi-yelp"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-yammer" data-bs-toggle="tooltip" title="mdi-yammer"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-xmpp" data-bs-toggle="tooltip" title="mdi-xmpp"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-xml" data-bs-toggle="tooltip" title="mdi-xml"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-wrench" data-bs-toggle="tooltip" title="mdi-wrench"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-wrap" data-bs-toggle="tooltip" title="mdi-wrap"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-vpn" data-bs-toggle="tooltip" title="mdi-vpn"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-vlc" data-bs-toggle="tooltip" title="mdi-vlc"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-video" data-bs-toggle="tooltip" title="mdi-video"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-usb" data-bs-toggle="tooltip" title="mdi-usb"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-update" data-bs-toggle="tooltip" title="mdi-update"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-unity" data-bs-toggle="tooltip" title="mdi-unity"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-undo" data-bs-toggle="tooltip" title="mdi-undo"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-ubuntu" data-bs-toggle="tooltip" title="mdi-ubuntu"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-tune" data-bs-toggle="tooltip" title="mdi-tune"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i className="mdi mdi-truck" data-bs-toggle="tooltip" title="mdi-truck"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-svg" data-bs-toggle="tooltip" title="mdi-svg"></i>
                  </li>
                  <li>
                    <i className="mdi mdi-subway" data-bs-toggle="tooltip" title="mdi-subway"></i>
                  </li>
                </ul>
              </div>
            </div>
