      ...
      <div className="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
        ...
        <div className="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
          <div className="dropdown">
            ...
            >
              <i className="isax isax-export-1 me-1"></i>
              Export
            </Link>
          ...
          <div className="d-flex align-items-center flex-wrap gap-2">
            <div className="dropdown">
              <Link href="#"
                ...
                data-bs-toggle="dropdown"
              >
                <i className="isax isax-sort me-1"></i>
                Sort By : <span className="fw-normal ms-1">Latest</span>
              </Link>
            ...
            <div className="dropdown">
              ...
              >
                <i className="isax isax-grid-3 me-1"></i>
                Column
              </Link>
              <ul className="dropdown-menu">
                <li>
        ...
        <table className="table table-nowrap datatable">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="text-dark">Stripe</td>
              <td className="action-item">
                <Link href="#" data-bs-toggle="dropdown">
                  <i className="fa-solid fa-ellipsis"></i>
                </Link>
                  ...
                  <div className="col-4">
                    <div className="p-3 border rounded-2">
                      <div className="d-flex align-items-center justify-content-between">
                        ...
                        <span className="avatar avatar-sm bg-light text-dark rounded-circle">
