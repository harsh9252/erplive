        ...
        <div className="col-12">
          <div className="card">
            ...
            <div className="card-body">
              ...
              Nulla <Linkbbr title="attribute">attr</Linkbbr> vitae elit libero, a pharetra augue.
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="col-xl-4">
          <div className="card card-h-100">
            ...
            <div className="card-body">
              ...
              <p>
                <Linkbbr title="attribute">attr</Linkbbr>
              </p>
              <p>
                <Linkbbr title="HyperText Markup Language" className="initialism">
                  HTML
                </Linkbbr>
              </p>
            </div>
          ...
          <div className="card card-h-100">
            ...
            <div className="card-body">
              <p className="text-muted">
                ...
                <Linkbbr title="PacesText Markup Language">HTML</Linkbbr> as the quote.
              </p>
              <blockquote className="blockquote">
                <p className="mb-0">
