          ...
          <div>
            <div className="d-flex align-items-center justify-content-between mb-3">
              <h6>
                <Link to="/customer-quotations">
                  <i className="isax isax-arrow-left me-2"></i>Quotations
                </Link>
              </h6>
            ...
            <div className="card">
              <div className="card-body">
                <h6 className="mb-3">Quotation Details</h6>
                          ...
                          <div className="col-lg-12">
                            <div className="mb-3">
                              <label className="form-label">
                                Create Quotation with/without GST
                              </label>
...
export default CustomerAddQuotation;
