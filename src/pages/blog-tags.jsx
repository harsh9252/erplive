      ...
      <div className="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
        ...
        <div className="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
          <div>
            ...
            >
              <i className="isax isax-add-circle5 me-1"></i>New Tag
            </Link>
          </div>
        </div>
      </div>
            ...
            <tr>
              ...
              <td>
                <span className="badge badge-soft-danger d-inline-flex align-items-center">
                  Inactive <i className="isax isax-tick-circle ms-1"></i>
                </span>
              </td>
              <td className="action-item">
                <Link href="#" data-bs-toggle="dropdown">
              ...
              <div className="modal-body">
                <div className="mb-0">
                  <label className="form-label">
                    Tag Name<span className="text-danger ms-1">*</span>
                  </label>
                  <input
        ...
        <div className="modal-dialog modal-dialog-centered modal-sm">
          <div className="modal-content">
            <div className="modal-body text-center">
              ...
              <h6 className="mb-1">Delete Blog Tag</h6>
              <p className="mb-3">Are you sure, you want to delete Blog Tag?</p>
              <div className="d-flex justify-content-center">
                <Link href="#" className="btn btn-outline-white me-3" data-bs-dismiss="modal">
                  Cancel
                </Link>
                <Link to="/blog-tags" className="btn btn-primary">
                  Yes, Delete
                </Link>
              </div>
            </div>
