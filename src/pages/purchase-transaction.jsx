        ...
        <div className="modal-dialog modal-dialog-centered modal-sm">
          <div className="modal-content">
            <div className="modal-body text-center">
              ...
              <h6 className="mb-1">Delete Purchase Transaction</h6>
              <p className="mb-3">Are you sure, you want to delete purchase transaction?</p>
              <div className="d-flex justify-content-center">
                <Link href="#" className="btn btn-outline-white me-3" data-bs-dismiss="modal">
                  Cancel
                </Link>
                <Link to="/purchase-transaction" className="btn btn-primary">
                  Yes, Delete
                </Link>
              </div>
            </div>
