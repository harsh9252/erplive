...
export default function CarBookingInvoice() {
  return (
        ...
        <div className="row justify-content-center">
          <div className="col-lg-10">
            ...
            <div className="d-flex align-items-center justify-content-between mb-3">
              <div>
                <h6 className="mb-1 fs-16">Dreams Car</h6>
              ...
              <div className="col-md-2 d-flex">
                <div className="d-flex align-items-center justify-content-center bg-light px-3 py-4 flex-fill">
                  <div className="text-center">
                    <p className="mb-2 text-gray-5 fw-medium fs-18">No Of Days</p>
                    <h4 className="mb-0 text-primary fw-semibold">15 Days</h4>
                  </div>
                </div>
              </div>
              <div className="col-md-2 d-flex">
                <div className="d-flex align-items-center justify-content-center bg-light px-3 py-4 flex-fill">
                  <div className="text-center">
                    <p className="mb-2 text-gray-5 fw-medium fs-18">Upto</p>
                    <h4 className="mb-0 text-primary fw-semibold">1500 Km</h4>
                  </div>
                </div>
              </div>
            </div>
            <div className="row mb-3 ">
              <div className="col-md-4">
                <div className="ribbon-tittle">
                  <div className="ribbon-text">
                    <span className="text-white">Hirer’s Information</span>
                  </div>
                </div>
              </div>
              <div className="col-md-4">
              ...
              <div className="col-md-4">
                <div className="ribbon-tittle">
                  <div className="ribbon-text">
                    <span className="text-white">Driver Information</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="row mb-3 ">
              <div className="col-md-4 d-flex">
                <div className="d-flex justify-content-between bg-light p-3 flex-fill">
                  <div className="d-flex flex-column">
                    <span className="mb-1">Hirer’s Name:</span>
                    <span className="mb-1">Passport NO:</span>
                    <span className="mb-1">Licence NO:</span>
                    <span className="mb-1">Date of birth:</span>
                    <span>Address:</span>
                  </div>
                  <div className="d-flex flex-column text-end">
                    <span className="text-dark mb-1">Jennifer Richards</span>
                    <span className="text-dark mb-1">AA123456</span>
                    <span className="text-dark mb-1">Toronto - G 28-26-23</span>
                    <span className="text-dark mb-1">05 Feb 1991</span>
              ...
              <div className="col-md-4 d-flex">
                <div className="d-flex justify-content-between bg-light p-3 flex-fill">
                  <div className="d-flex flex-column">
                    <span className="mb-1">Car Mode:</span>
                    <span className="mb-1">Type:</span>
                    <span className="mb-1">Licence NO:</span>
                    <span>Expire Date :</span>
                  </div>
                  <div className="d-flex flex-column text-end">
                    <span className="text-dark mb-1">Lamborghini Aventador</span>
                    <span className="text-dark mb-1">Aventador</span>
                    <span className="text-dark mb-1">LI-25345</span>
                    <span className="text-dark mb-1">05 Feb 2026</span>
                  </div>
                </div>
              </div>
              <div className="col-md-4 d-flex">
                <div className="d-flex justify-content-between bg-light p-3 flex-fill">
                  <div className="d-flex flex-column">
                    <span className="mb-1">Driver Name :</span>
                    <span className="mb-1">Driving Licence :</span>
                    <span className="mb-1">Expire Date :</span>
                    <span>Contact :</span>
                  </div>
                  <div className="d-flex flex-column text-end">
                    <span className="text-dark mb-1">Jennifer Law</span>
                    <span className="text-dark mb-1">LI-25345</span>
                    <span className="text-dark mb-1">05 Feb 2026</span>
                    <span className="text-dark mb-1">+1-613-555-0141</span>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div className="d-flex flex-column">
                          <span className="text-dark">
                            Lamborghini Aventador - 15 Days - Driver Services - Road Fee
                          </span>
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex flex-column">
                          <span className="text-dark">Premium location fee</span>
                        </div>
                      </td>
                      <td>
