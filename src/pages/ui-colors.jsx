          ...
          <div className="card">
            ...
            <div className="card-body pb-1">
              <div className="d-flex flex-wrap colors_parent">
                <div>
                  <div className="color-box bg-primary p-4"></div>
                  <p className="flex-1 text-sm my-1 pt-1">Primary</p>
                  <p className="flex-0 text-sm">#7539FF</p>
                </div>
                <div>
                  <div className="color-box bg-secondary p-4"></div>
                  <p className="flex-1 text-sm my-1 pt-1">Secondary</p>
                  <p className="flex-0 text-sm">#3F8BFE</p>
                </div>
                <div>
                  <div className="color-box bg-warning p-4"></div>
                  <p className="flex-1 text-sm my-1 pt-1">warning</p>
                  <p className="flex-0 text-sm">#E2B93B</p>
                </div>
                <div>
                  <div className="color-box bg-info p-4"></div>
                  <p className="flex-1 text-sm my-1 pt-1">info</p>
                  <p className="flex-0 text-sm">#2F80ED</p>
                </div>
                <div>
                  <div className="color-box bg-success p-4"></div>
                  <p className="flex-1 text-sm my-1 pt-1">success</p>
                  <p className="flex-0 text-sm">#27AE60</p>
                </div>
                <div>
                  <div className="color-box bg-danger p-4"></div>
                  <p className="flex-1 text-sm my-1 pt-1">danger</p>
                  <p className="flex-0 text-sm">#EF1E1E</p>
                </div>
                <div>
                  <div className="color-box bg-light border p-4"></div>
                  <p className="flex-1 text-sm my-1 pt-1">light</p>
                  <p className="flex-0 text-sm">#F7F8F9</p>
                </div>
                <div>
                  <div className="color-box bg-dark p-4"></div>
                  <p className="flex-1 text-sm my-1 pt-1">dark</p>
                  <p className="flex-0 text-sm">#262626</p>
                </div>
              </div>
        ...
        <div className="col-lg-12 col-sm-6">
          <div className="card">
            ...
            <div className="card-body py-1">
              <div className="row row-cols-12 d-flex align-items-center">
                <div className="p-3 col">
                  <div className="m-2 bg-soft-primary mx-auto color-container shadow-none"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center">
                    <code>.bg-primary-subtle</code>
                  </p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-soft-secondary mx-auto color-container shadow-none"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center">
                    <code>.bg-secondary-subtle</code>
                  </p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-soft-warning mx-auto color-container shadow-none"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center">
                    <code>.bg-warning-subtle</code>
                  </p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-soft-info mx-auto color-container shadow-none"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center">
                    <code>.bg-info-subtle</code>
                  </p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-soft-success mx-auto color-container shadow-none"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center">
                    <code>.bg-success-subtle</code>
                  </p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-soft-danger mx-auto color-container shadow-none"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center">
                    <code>.bg-danger-subtle</code>
                  </p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-soft-light mx-auto color-container"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center">
                    <code>.bg-light-subtle</code>
                  </p>
                </div>
                <div className="p-3 col">
                  <div className="m-2 bg-soft-dark mx-auto color-container shadow-none"></div>
                  <p className="pb-0 mb-0 fw-semibold text-center">
              ...
              <div className="row row-cols-12 d-flex align-items-center">
                <div className="p-3 col">
                  <div className="m-2 bg-outline-primary mx-auto color-container">
                    <i data-feather="smile" className="fs-18"></i>
                  </div>
                  <p className="pb-0 mb-0 fw-semibold text-center">
