...
const EditCreditNotes = () => {
  return (
    <>
      <div className="row">
        <div className="col-xxl-11 col-lg-11 mx-auto">
          <div>
                            ...
                            >
                              ...
                              <li className="nav-item" role="presentation">
                                <Link
                                  ...
                                  tabIndex="-1"
                                >
                                  <i className="isax isax-document me-1"></i>Add Terms &amp;
                                  Conditions
                                </Link>
                              </li>
                              <li className="nav-item" role="presentation">
                                <Link
                                  className="nav-link d-inline-flex align-items-center border fs-12 fw-semibold rounded-2 active"
                                  data-bs-toggle="tab"
                                  data-bs-target="#bank"
                                  href="#"
                                  aria-selected="true"
