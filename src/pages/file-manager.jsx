  ...
  return (
    <>
      <div className="mb-3 d-flex align-items-center justify-content-between flex-wrap gap-2">
        <div>
          <h5 className="mb-1 fw-bold">File Manager</h5>
        </div>
        <div className="d-flex my-xl-auto right-content align-items-center flex-wrap table-header">
          ...
          <div className="mb-2">
            ...
            >
              <i className="ti ti-circle-plus me-2"></i>Create Folder
            </Link>
          </div>
        </div>
      </div>
              ...
              <div className="d-flex align-items-center justify-content-between mb-2">
                ...
                <div className="dropdown">
                  ...
                  <ul className="dropdown-menu dropdown-menu-end p-3">
                    <li>
                      <Link href="#" className="dropdown-item rounded-1">
                        <i className="ti ti-folder-open me-2"></i>Open
                      </Link>
                    </li>
                    <li>
                      <Link href="#" className="dropdown-item rounded-1">
                    ...
                    <li>
                      <Link href="#" className="dropdown-item rounded-1">
                        <i className="ti ti-status-change me-1"></i>Reset
                      </Link>
                    </li>
                  </ul>
                </div>
          ...
          <div className="card">
            <div className="card-body p-3">
                ...
                <div className="d-flex align-items-center justify-content-between">
                  <div className="d-flex align-items-center overflow-hidden">
                    ...
                    <div className="overflow-hidden ms-2">
                      ...
                      <p className="fs-12 text-truncate"></p>
                    </div>
                  </div>
              ...
              <div className="files-list nav d-block">
                ...
                >
                  <i className="ti ti-folder-up me-2"></i>All Folder / Files
                </Link>
                <Link href="javscript:void(0);" className="d-flex align-items-center fw-medium p-2">
                  <i className="ti ti-star me-2"></i>Drive
                </Link>
                <Link href="javscript:void(0);" className="d-flex align-items-center fw-medium p-2">
                  <i className="ti ti-octahedron me-2"></i>Dropbox
                </Link>
                <Link href="javscript:void(0);" className="d-flex align-items-center fw-medium p-2">
                  <i className="ti ti-share-2 me-2"></i>Shared with Me
                </Link>
                <Link href="javscript:void(0);" className="d-flex align-items-center fw-medium p-2">
                  <i className="ti ti-file me-2"></i>Document
                </Link>
                <Link href="javscript:void(0);" className="d-flex align-items-center fw-medium p-2">
                  <i className="ti ti-clock-hour-11 me-2"></i>Recent File
                </Link>
                <Link href="javscript:void(0);" className="d-flex align-items-center fw-medium p-2">
              ...
              <div className="d-flex align-items-center justify-content-between mb-3">
                <div className="d-flex align-items-center overflow-hidden">
                  <span className="avatar avatar-md badge-soft-primary">
                    <i className="ti ti-photo fs-20 text-secondary"></i>
                  </span>
                  <div className="overflow-hidden ms-2">
        ...
        <div className="col-xl-9">
          <div className="border-bottom mb-3">
            <div className="d-flex align-items-center justify-content-between mb-2">
              ...
              <div>
                <Link href="#" className="mb-2 me-3 fw-medium link-default">
                  Close
                </Link>
                ...
                <div className="card access-wrap flex-fill">
                  <div className="card-body text-center">
                    ...
                    <h6 className="mb-2 fw-medium">
                      <Link href="#" data-bs-toggle="offcanvas" data-bs-target="#preview">
                        Final.doc
                      </Link>
                    </h6>
                  ...
                  <div className="ms-2">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <p className="fs-12 mb-0 d-flex align-items-center">
                        <i className="ti ti-circle-filled fs-6 me-2 text-dark"></i>135 files
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="dropdown ms-2">
                    ...
                    <ul className="dropdown-menu dropdown-menu-end p-3">
                      <li>
                        ...
                        >
                          <i className="ti ti-folder-open me-2"></i>Preview
                        </Link>
                      </li>
                      <li>
                        <Link href="#" className="dropdown-item rounded-1">
                          <i className="ti ti-copy me-2"></i>Duplicate
                        </Link>
                      </li>
                      <li>
                        <Link href="#" className="dropdown-item rounded-1">
                          <i className="ti ti-arrow-left-right me-2"></i>Move
                        </Link>
                      </li>
                      <li>
                        <Link href="#" className="dropdown-item rounded-1">
                          <i className="ti ti-user-plus me-2"></i>Invite
                        </Link>
                      </li>
                      <li>
                        <Link href="#" className="dropdown-item rounded-1">
                          <i className="ti ti-share-3 me-2"></i>Share Link
                        </Link>
                      </li>
                      <li>
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <p className="fs-12 mb-0 d-flex align-items-center">
                        <i className="ti ti-circle-filled fs-6 me-2 text-dark"></i>15 files
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <p className="fs-12 mb-0 d-flex align-items-center">
                        <i className="ti ti-circle-filled fs-6 me-2 text-dark"></i>115 files
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="border-bottom mb-3">
            ...
            <div className="owl-carousel files-carousel">
              ...
              <div className="files-wrap">
                <div className="bg-transparent-dark p-5 d-flex align-items-center justify-content-center files-icon">
                  <i className="fa-regular fa-file-audio fs-24 text-dark"></i>
                </div>
                <div className="bg-white d-flex align-items-center justify-content-between p-3 files-content">
                  <h6 className="fw-medium text-truncate">
                    <Link href="#" data-bs-toggle="offcanvas" data-bs-target="#preview">
              ...
              <div className="files-wrap">
                <div className="bg-transparent-dark p-5 d-flex align-items-center justify-content-center files-icon">
                  <i className="fa-solid fa-file-zipper fs-24 text-dark"></i>
                </div>
                <div className="bg-white d-flex align-items-center justify-content-between p-3 files-content">
          ...
          <div className="d-flex align-items-center justify-content-between mb-2 table-header">
            ...
            <div className="d-flex align-items-center">
              ...
              <Link href="#" className="link-primary fw-medium mb-2">
                View All
              </Link>
            </div>
          </div>
                  ...
                  <td>
                    <div className="d-flex align-items-center file-name-icon">
                      <Link
                        ...
                        data-bs-target="#preview"
                      >
                        <img src="/assets/img/icons/file-01.svg" className="img-fluid" alt="img" />
                      </Link>
                      <div className="ms-2">
                  ...
                  <td>
                    <div className="d-flex align-items-center file-name-icon">
                      <Link
                        ...
                        data-bs-target="#preview"
                      >
                        <img src="/assets/img/icons/file-02.svg" className="img-fluid" alt="img" />
                      </Link>
                      <div className="ms-2">
                        <p className="text-dark fw-medium  mb-0">
                          <Link href="#" data-bs-toggle="offcanvas" data-bs-target="#preview">
                  ...
                  <td>
                    <div className="d-flex align-items-center file-name-icon">
                      <Link
                        ...
                        data-bs-target="#preview"
                      >
                        <img src="/assets/img/icons/file-03.svg" className="img-fluid" alt="img" />
                      </Link>
                      <div className="ms-2">
                        <p className="text-dark fw-medium  mb-0">
                          <Link href="#" data-bs-toggle="offcanvas" data-bs-target="#preview">
                  ...
                  <td>
                    <div className="d-flex align-items-center file-name-icon">
                      <Link
                        ...
                        data-bs-target="#preview"
                      >
                        <img src="/assets/img/icons/file-04.svg" className="img-fluid" alt="img" />
                      </Link>
                      <div className="ms-2">
                        <p className="text-dark fw-medium  mb-0">
                          <Link href="#" data-bs-toggle="offcanvas" data-bs-target="#preview">
                  ...
                  <td>
                    <div className="d-flex align-items-center file-name-icon">
                      <Link
                        ...
                        data-bs-target="#preview"
                      >
                        <img src="/assets/img/icons/file-05.svg" className="img-fluid" alt="img" />
                      </Link>
                      <div className="ms-2">
                        <p className="text-dark fw-medium  mb-0">
                          <Link href="#" data-bs-toggle="offcanvas" data-bs-target="#preview">
      ...
      <div className="offcanvas-header d-flex align-items-center justify-content-between bg-dark">
        ...
        <div className="d-flex align-items-center">
          <Link href="#" className="d-flex align-items-center justify-content-center me-3">
            <i className="ti ti-star-filled filled text-warning"></i>
          </Link>
          <Link href="#" className="d-flex align-items-center justify-content-center text-white me-3">
      ...
      <div className="offcanvas-body p-0">
        <div className="bg-light document-wrap text-center">
          ...
          <h4 className="mb-1">
            ...
            <span className="badge badge-soft-secondary fw-normal fs-12 ms-2">2.4 GB</span>
          </h4>
        ...
        <div className="preview-content">
            ...
            <div className="card-body p-3 pb-0">
              ...
              <ul className="recent-activity mb-3">
                <li className="d-flex">
                  ...
                  <div className="ms-2 flex-grow-1">
                    <p className="mb-0">
                      <span className="text-dark">Mercy</span> Added New File in{' '}
                      <span className="text-dark">Drive</span>
                    </p>
                    <p className="mb-0">05:22 PM</p>
                    <div className="bg-light rounded p-2 d-flex align-items-center justify-content-between mt-1">
                      <div className="d-flex align-items-center">
                        <i className="ti ti-video text-dark fs-16"></i>
                ...
                <li className="d-flex">
                  ...
                  <div className="ms-2 flex-grow-1">
                    <p className="mb-0">
                      <span className="text-dark">Druman</span> Added New File in{' '}
                      <span className="text-dark">ROOT FOLDER</span>
                    </p>
                    ...
                    <div className="bg-light rounded p-2 d-flex align-items-center justify-content-between mt-1">
                      <div className="d-flex align-items-center">
                        <i className="ti ti-file-zip text-dark fs-16"></i>
              ...
              <ul className="recent-activity mb-3">
                ...
                <li className="d-flex">
                  ...
                  <div className="ms-2 flex-grow-1">
                    <p className="mb-0">
                      <span className="text-dark">Jackson</span> Added New File in{' '}
                      <span className="text-dark">Drive</span>
                    </p>
                    <p className="mb-0">05:23 PM</p>
                    <div className="bg-light rounded p-2 d-flex align-items-center justify-content-between mt-1">
          ...
          <div className="d-flex align-items-center justify-content-between">
            ...
            <Link href="#" className="fs-12 mb-3" data-bs-toggle="modal" data-bs-target="#add_member">
              Add Members
            </Link>
          </div>
