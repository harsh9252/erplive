      ...
      <div className="row">
        <div className="col-md-11 mx-auto">
          <div className="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
            <div>
              <h6>
                <Link to="/purchase-orders" className="d-flex align-items-center ">
                  <i className="isax isax-arrow-left me-2"></i>Purchase Order
                </Link>
              </h6>
            </div>
                        ...
                        <div className="row">
                          ...
                          <div>
                            <Link href="#" className="d-flex align-items-center ">
                              <i className="isax isax-add-circle5 me-1 text-primary"></i>Add Due
                              Date
                            </Link>
                          </div>
                        </div>
                          ...
                          <div className="col-md-12">
                            <div className="p-2 border rounded d-flex justify-content-between">
                              <div className="d-flex align-items-center">
                                <div className="form-check form-switch form-check-reverse d-flex align-items-center mb-0">
                                  <input
                                ...
                                <p className="text-gray-9">Enable Tax</p>
                              </div>
                              <div>
                                <Link href="#">
                        ...
                        <div className="p-3 bg-light rounded border">
                          <div className="d-flex">
                            ...
                            <div>
                              ...
                              <p className="mb-0">15 Hodges Mews, HP12 3JL, United Kingdom</p>
                        ...
                        <div className="p-3 bg-light rounded border">
                          <div className="d-flex">
                            ...
                            <div>
                              ...
                              <p className="mb-0">299 Star Trek Drive, Florida, 32405, USA</p>
                              <p className="mb-0">Phone : +1 54664 75945</p>
                              <p className="mb-0">Email : </p>
                              <p className="text-dark mb-0">GST : 243E45767889</p>
                            </div>
                ...
                <div className="table-responsive rounded border-bottom-0 border mb-3">
                  <table className="table table-nowrap add-table mb-0">
                    ...
                    <tbody className="add-tbody">
                      ...
                      <tr>
                        <td>
                          <input type="text" className="form-control" value="Enter Product Name" />
                        </td>
                        <td>
                ...
                <div className="row">
                        ...
                        <div className="tab-content">
                          <div className="tab-pane active show" id="notes" role="tabpanel">
                            ...
                            <textarea className="form-control">
                              Please ensure all payment details are correct before processing. Late
                              payments may incur additional fees. Contact support for queries. Keep
                  ...
                  <div className="col-md-5">
                    <ul className="mb-0 ps-0 list-unstyled">
                      ...
                      <li className="mb-3">
                        <Link href="#" className="d-flex align-items-center ">
                          <i className="isax isax-add-circle5 text-primary me-1"></i>Add Additional
                          Charges
                        </Link>
                      </li>
                      <li className="mb-3">
                      ...
                      <li className="pb-3 border-gray border-bottom">
                        <div className="p-2  d-flex justify-content-between">
                          <div className="d-flex align-items-center">
                            ...
                            <p className="text-gray-9">Round Off Total</p>
                          </div>
                          <div>
                      ...
                      <div className="singnature-upload bg-light d-flex align-items-center justify-content-center">
                        <div className="drag-upload-btn bg-light position-relative mb-2 fs-14 fw-normal text-gray-5">
                          <i className="isax isax-image me-1 text-primary"></i>Upload Image
...
export default EditPurchasesOrders;
