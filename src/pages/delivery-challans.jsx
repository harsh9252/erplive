    ...
    <>
      <div className="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
        ...
        <div className="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
          ...
          <div>
            <Link to="/add-delivery-challan" className="btn btn-primary d-flex align-items-center">
              <i className="isax isax-add-circle5 me-1"></i>New Delivery Challan
            </Link>
          </div>
        </div>
      </div>
        ...
        <table className="table table-nowrap datatable">
          <thead className="thead-light">
            <tr>
              ...
              <th className="no-sort">Challan ID</th>
              <th>Customer</th>
              <th>Amount</th>
              <th>Category</th>
              <th>Created On</th>
            ...
            <tr>
              ...
              <td className="action-item">
                ...
                <ul className="dropdown-menu">
                  ...
                  <li>
                    <Link href="#" className="dropdown-item d-flex align-items-center">
                      <i className="isax isax-copy me-2"></i>Clone
                    </Link>
                  </li>
                  <li>
                    <Link href="#" className="dropdown-item d-flex align-items-center">
              ...
              <div className="dropdown">
                ...
                <div className="dropdown-menu shadow-lg w-100 dropdown-info">
                  ...
                  <ul className="mb-3">
                    <li>
                      <label className="dropdown-item px-2 d-flex align-items-center text-dark">
                        <input className="form-check-input m-0 me-2" type="checkbox" /> CH0014
                      </label>
                    </li>
                    <li>
                      <label className="dropdown-item px-2 d-flex align-items-center text-dark">
                        <input className="form-check-input m-0 me-2" type="checkbox" /> CH0013
                      </label>
                    </li>
                    <li>
                      <label className="dropdown-item px-2 d-flex align-items-center text-dark">
                        <input className="form-check-input m-0 me-2" type="checkbox" /> CH0012
                      </label>
                    </li>
                    <li>
                      <label className="dropdown-item px-2 d-flex align-items-center text-dark">
                        <input className="form-check-input m-0 me-2" type="checkbox" /> CH0011
                      </label>
                    </li>
                  </ul>
                </div>
        ...
        <div className="modal-dialog modal-dialog-centered modal-sm">
          <div className="modal-content">
            <div className="modal-body text-center">
              ...
              <h6 className="mb-1">Delete Delivery Challan</h6>
              <p className="mb-3">Are you sure, you want to delete Delivery Challan?</p>
              <div className="d-flex justify-content-center">
                <Link href="#" className="btn btn-outline-white me-3" data-bs-dismiss="modal">
                  Cancel
                </Link>
                <Link to="/delivery-challans" className="btn btn-primary">
                  Yes, Delete
                </Link>
              </div>
            </div>
