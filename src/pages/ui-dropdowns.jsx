      ...
      <div className="row">
        ...
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              <p className="text-muted mb-3">
                Use <code>data-bs-offset</code> or <code>data-bs-reference</code> to change the
        ...
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              <p>
                You can use the <code>autoClose</code> option to change this behavior of the
                dropdown.
              </p>
          ...
          <div className="card">
            ...
            <div className="card-body">
              <p className="text-muted">
                ...
                larger, add <code>.dropdown-menu{-sm | -md | -lg | -xl | -xxl}-end</code>.
              </p>
              <div className="btn-group">
                <button
                  type="button"
          ...
          <div className="card">
            ...
            <div className="card-body">
              <p className="text-muted">
                ...
                larger, add <code>.dropdown-menu-end</code> and{' '}
      ...
      <div className="row">
        ...
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              <p className="text-muted">
                Trigger dropdown menus at the right of the elements by adding <code>.dropleft</code>{' '}
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <div className="btn-group">
                ...
                <div className="dropdown-menu p-3 text-muted" style="max-width: 200px;">
