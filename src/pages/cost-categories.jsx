                            ...
                            <td className="text-end pe-4">
                              <div className="dropdown">
                                ...
                                <ul className="dropdown-menu dropdown-menu-end border-0 shadow rounded-12">
                                  <li>
                                    <button className="dropdown-item py-2" onClick={() => handleEdit(category.id)}>
                                      <i className="isax isax-edit-2 me-2 text-warning"></i>Edit Category
                                    </button>
                                  </li>
                                  <li>
                                    <button className="dropdown-item py-2" onClick={() => handleDelete(category.id)}>
                                      <i className="isax isax-trash me-2 text-danger"></i>Delete Category
                                    </button>
                                  </li>
                                </ul>
                              </div>
