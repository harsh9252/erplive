      ...
      <div className="row">
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              <form>
                <div className="row mb-3">
                  <label htmlFor="inputEmail1" className="col-sm-2 form-label">
                    Email
                  </label>
                ...
                <div className="row mb-3">
                  <label htmlFor="inputPassword1" className="col-sm-2 form-label">
                    Password
                  </label>
                  <div className="col-sm-10">
                    <div className="input-group">
        ...
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              <div className="row mb-3">
                <label htmlFor="colFormLabelSm" className="col-sm-2 form-label form-label-sm">
                  Email
                </label>
                <div className="col-sm-10">
                  <input
              ...
              <div className="row mb-3">
                <label htmlFor="colFormLabel" className="col-sm-2 form-label">
                  Email
                </label>
                <div className="col-sm-10">
                  <input
              ...
              <div className="row">
                <label htmlFor="colFormLabelLg" className="col-sm-2 form-label form-label-lg">
                  Email
                </label>
                <div className="col-sm-10">
                  <input
