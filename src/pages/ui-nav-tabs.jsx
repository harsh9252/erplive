            ...
            <div className="card-body">
              <ul className="nav nav-tabs mb-3">
                <li className="nav-item">
                  <Link href="#home" data-bs-toggle="tab" aria-expanded="false" className="nav-link">
                    Home
                  </Link>
                </li>
                <li className="nav-item">
              ...
              <div className="tab-content">
                <div className="tab-pane" id="home">
                  <p className="mb-0">
                    Welcome to the dashboard! Access key metrics, recent updates, and quick links to
                    manage your activity. Use this panel to stay on top of your workflow and
                    performance goals.
                  </p>
                </div>
                <div className="tab-pane show active" id="profile">
                  <p className="mb-0">
                    Manage your profile details, update your contact info, and review your login
                    activity. Keeping your account information accurate ensures a smooth and secure
                    experience.
                  </p>
                </div>
                <div className="tab-pane" id="message">
                  <p className="mb-0">
                    View recent messages, send new replies, and stay connected with your team. The
                    messaging center helps you manage conversations efficiently and never miss
                    important updates.
                  </p>
                </div>
              </div>
          ...
          <div className="card">
            ...
            <div className="card-body">
              <ul className="nav nav-tabs nav-solid-primary mb-3">
                <li className="nav-item">
                  <Link className="nav-link active" href="#solid-tab1" data-bs-toggle="tab">
                    Home
                  </Link>
                </li>
                <li className="nav-item">
          ...
          <div className="card">
            ...
            <div className="card-body">
              <ul className="nav nav-tabs nav-solid-primary nav-justified mb-3">
                <li className="nav-item">
                  <Link className="nav-link active" href="#solid-justified-tab1" data-bs-toggle="tab">
                    Home
                  </Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" href="#solid-justified-tab2" data-bs-toggle="tab">
                    Profile
                  </Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" href="#solid-justified-tab3" data-bs-toggle="tab">
                    Messages
                  </Link>
                </li>
              </ul>
          ...
          <div className="card">
            ...
            <div className="card-body">
              <ul className="nav nav-tabs nav-solid-success nav-tabs-rounded mb-3">
                ...
                <li className="nav-item">
                  <Link className="nav-link" href="#solid-rounded-tab3" data-bs-toggle="tab">
                    Messages
                  </Link>
                </li>
              </ul>
          ...
          <div className="card">
            ...
            <div className="card-body">
              <ul className="nav nav-tabs nav-solid-success nav-tabs-rounded nav-justified mb-3">
                ...
                <li className="nav-item">
                  <Link className="nav-link" href="#solid-rounded-justified-tab2" data-bs-toggle="tab">
                    Profile
                  </Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" href="#solid-rounded-justified-tab3" data-bs-toggle="tab">
                    Messages
                  </Link>
                </li>
              </ul>
              ...
              <div className="row">
                ...
                <div className="col-sm-9">
                  <div className="tab-content" id="v-pills-tabContent">
                    ...
                    >
                      <p className="mb-0">
                        Welcome to the dashboard! Access key metrics, recent updates, and quick
                        links to manage your activity. Use this panel to stay on top of your
                        workflow and performance goals.
                      </p>
                    </div>
                    <div
                    ...
                    >
                      <p className="mb-0">
                        Manage your profile details, update your contact info, and review your login
                        activity. Keeping your account information accurate ensures a smooth and
                        secure experience.
                      </p>
                    </div>
                    <div
                    ...
                    >
                      <p className="mb-0">
                        View recent messages, send new replies, and stay connected with your team.
                        The messaging center helps you manage conversations efficiently and never
