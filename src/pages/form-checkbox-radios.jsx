          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <div className="mb-3">
                ...
                <input type="checkbox" className="btn-check" id="btn-check-2" checked />
          ...
          <div className="card card-h-100">
            ...
            <div className="card-body">
              ...
              <div className="form-check form-switch form-check-reverse">
                ...
                <label className="form-check-label" htmlFor="switchCheckReverse">
            ...
            <div className="card-body">
              ...
              <div className="form-check form-switch mb-2">
                <input
                  ...
                  disabled
                />
                <label className="form-check-label" htmlFor="switchCheckDisabled">
              ...
              <div className="form-check form-switch mb-2">
                <input
                  ...
                  disabled
                />
                <label className="form-check-label" htmlFor="switchCheckCheckedDisabled">
