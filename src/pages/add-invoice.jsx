...
const AddInvoice = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const prefixOffset = savedInvoices.length > 0
      ? parseInt(savedInvoices[0].id.split('-')[1] || savedInvoices.length) + 1
      : 1;
    const invId = `INV-${String(prefixOffset).padStart(3, '0')}`;
    ...
    toast.success('Invoice created successfully!', { position: 'top-right', autoClose: 3000 });
    navigate('/invoices');
  };
