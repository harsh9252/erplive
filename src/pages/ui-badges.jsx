      ...
      <div className="row">
          ...
          <div className="card">
            ...
            <div className="card-body">
              <p className="text-xl mb-3">
                Use the <span className="text-secondary">badge</span> class to show a default badge.
              </p>
        ...
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              <p className="text-xl mb-3">
                Use the <code>rounded-pill badge-soft-</code> to create a soft badge more rounded
              </p>
              <div className="d-flex flex-wrap gap-2">
        ...
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              <p className="text-xl mb-3">
                Use the <code>rounded-pill badge-outline-</code> class to create a outline pill
                badge.
              </p>
              <div className="d-flex flex-wrap gap-2">
          ...
          <div className="card">
            ...
            <div className="card-body d-flex flex-wrap gap-4">
              <button type="button" className="btn btn-primary btn-md position-relative">
                Inbox
                <span className="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-secondary"></span>
                99+
