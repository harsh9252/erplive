      ...
      <div className="row">
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <div className="mb-3">
                <label htmlFor="form-password1" className="form-label fs-14">
                  Enter Password
                </label>
                <div className="input-group">
                  <div className="input-group-text">
        ...
        <div className="col-xl-6">
          <div className="card card-h-100">
            ...
            <div className="card-body">
              <div className="mb-3">
                <label htmlFor="colFormLabelSm" className="form-label form-label-sm">
                  Email
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="colFormLabelLg" className="form-label form-label-lg">
                  Email
                </label>
                <input
                  type="email"
