...
const EditLedgerGroup = () => {
  ...
  useEffect(() => {
    ...
    setFormData(sampleGroup);
    setLoading(false);

    // TODO: Call API when backend is ready
    // ledgerGroupService.getGroup(id)
    //   .then(data => {
    //     setFormData(data);
    //     setLoading(false);
    //   })
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Ledger Group updated:', submitData);
    // TODO: Call API when backend is ready
    // ledgerGroupService.updateGroup(id, submitData)
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="d-flex gap-2 justify-content-end">
              ...
              <button type="submit" className="btn btn-primary">
                <i className="isax isax-save-2 me-2"></i>Update Group
              </button>
            </div>
          </form>
        </div>
