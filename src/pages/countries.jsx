      ...
      <div className="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
        ...
        <div className="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
          ...
          <div>
            ...
            >
              <i className="isax isax-add-circle5 me-1"></i>New Country
            </Link>
          </div>
        </div>
      </div>
        ...
        <table className="table table-nowrap datatable">
          <thead className="thead-light">
            <tr>
              ...
              <th className="no-sort">Country Id</th>
                  ...
                  <ul className="mb-3">
                    ...
                    <li>
                      <label className="dropdown-item px-2 d-flex align-items-center text-dark">
                        <input className="form-check-input m-0 me-2" type="checkbox" /> US
                      </label>
                    </li>
                    <li>
                      <label className="dropdown-item px-2 d-flex align-items-center text-dark">
                        <input className="form-check-input m-0 me-2" type="checkbox" /> DE
                      </label>
                    </li>
                    <li>
                      <label className="dropdown-item px-2 d-flex align-items-center text-dark">
                        <input className="form-check-input m-0 me-2" type="checkbox" /> IN
                      </label>
                    </li>
                    <li>
                      <label className="dropdown-item px-2 d-flex align-items-center text-dark">
                        <input className="form-check-input m-0 me-2" type="checkbox" /> AU
                      </label>
                    </li>
                    <li>
                      <label className="dropdown-item px-2 d-flex align-items-center text-dark">
                        <input className="form-check-input m-0 me-2" type="checkbox" /> BR
                      </label>
                    </li>
                    <li>
                      <label className="dropdown-item px-2 d-flex align-items-center text-dark">
                        <input className="form-check-input m-0 me-2" type="checkbox" /> CN
                      </label>
                    </li>
                    <li>
                      <label className="dropdown-item px-2 d-flex align-items-center text-dark">
                        <input className="form-check-input m-0 me-2" type="checkbox" /> AR
                      </label>
                    </li>
                    <li>
                      <label className="dropdown-item px-2 d-flex align-items-center text-dark">
                        <input className="form-check-input m-0 me-2" type="checkbox" /> RU
                      </label>
                    </li>
                    <li>
                      <label className="dropdown-item px-2 d-flex align-items-center text-dark">
                        <input className="form-check-input m-0 me-2" type="checkbox" /> CA
                      </label>
                    </li>
                    <li>
                      <label className="dropdown-item px-2 d-flex align-items-center text-dark">
                        <input className="form-check-input m-0 me-2" type="checkbox" /> IT
                      </label>
                    </li>
                  </ul>
              ...
              <div className="modal-body">
                <div className="col-md-12">
                  <div className="mb-3">
                    ...
                    <input type="text" className="form-control" placeholder="AU" />
                  </div>
                </div>
                <div className="col-md-12">
                  <div className="mb-3">
                    ...
                    <input type="text" className="form-control" placeholder="036" />
                  </div>
                </div>
                <div className="col-md-12">
                  <div className="mb-0">
        ...
        <div className="modal-dialog modal-dialog-centered modal-sm">
          <div className="modal-content">
            <div className="modal-body text-center">
              ...
              <h6 className="mb-1">Delete Country</h6>
