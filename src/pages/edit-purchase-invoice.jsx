...
const EditPurchaseInvoice = () => {
  ...
  const fetchData = useCallback(async () => {
    try {
      const [invoiceRes, vendorsRes, itemsRes, warehousesRes, settingsRes] = await Promise.all([
    ...
    <div className="container-fluid py-4">
      ...
      <form onSubmit={handleSubmit}>
        <div className="card border-0 shadow-sm mb-4">
          <div className="card-header bg-white py-3 text-warning">
            <h6 className="mb-0 fw-bold"><i className="isax isax-edit me-2"></i>Invoice Header (Draft Mode)</h6>
          </div>
            ...
            <div className="card border-0 shadow-sm bg-primary bg-opacity-10 h-100">
              ...
              <div className="card-footer bg-transparent border-0 pt-0 pb-4 px-4">
                <div className="row g-2">
                  <div className="col-6">
                    <button type="button" className="btn btn-outline-white w-100 rounded-pill shadow-none border" onClick={() => navigate(`/invoicing/purchases/${id}`)}>Cancel</button>
                  </div>
                  <div className="col-6">
